...
export const CHANGELOG: LogEntry[] = [
  {
    ...
    items: [
      ...
      'The loading screen wears the same bus as everything else now (as does the browser tab icon), and when it hands over to the menu that bus pulls out from the middle of the screen and drives off, towing the loading screen with it. Once per visit, and it sits out entirely if your system asks for reduced motion.',
