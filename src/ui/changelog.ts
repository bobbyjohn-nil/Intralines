...
export const CHANGELOG: LogEntry[] = [
  {
    ...
    items: [
      ...
      'The loading screen wears the same bus as everything else now (as does the browser tab icon), and when it hands over to the menu that bus pulls out from the middle of the screen and drives off, towing the loading screen with it.',
      ...
      'The loading screen now hands over to the menu properly: a bus drives in and tows it off to one side. Once per visit, and it sits out entirely if your system asks for reduced motion.',
