...
export const CHANGELOG: LogEntry[] = [
  {
    ...
    items: [
      ...
      'The demand layers are readable now. They used to scatter a dot over every census block group — several hundred of them, covering the whole city and telling you nothing you could act on. Each layer now pools that into the dozen biggest pockets of demand, drawn firmly where none of your stops is within a short walk and faded where one already is, with a key down the left listing them biggest-first with their numbers. The answer to “what do I do with this” is now on screen: run a line from a big unserved pocket of homes to a big pocket of jobs.',
